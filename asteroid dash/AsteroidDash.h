...
public:
    ...
    // Command list to store game commands
    ...
    // Grid dimensions
    int grid_width;    // Number of columns in the grid
    int grid_height;   // Number of rows in the grid
    ...
    // Function to read commands from the command file
    void read_commands(const string &commands_file);

    void place_player(const vector<vector<bool>>& spacecraft_shape, int start_row, int start_col);
